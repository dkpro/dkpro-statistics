 ...
 * References:<ul>
 * <li>Agresti, A.: Modelling patterns of agreement and disagreement. 
 *   Statistical Methods in Medical Research 1(2): 201-218, 1992.</li>
 * <li>Landis J.R. & Koch G.G.: An application of hierarchical kappa-type 
 *   statistics in the assessment of majority agreement among multiple 
 *   observers. Biometrics 33:363-374, 1977.</li></ul>
 * @author Christian M. Meyer
 */
public class Agresti1992Test extends TestCase {
	 ...
	 *  Agresti (1992: p. 202), originally derived from Landis&Koch (1977). */
