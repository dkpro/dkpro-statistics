...
/**
 * Implementation of a simple "max" percentage agreement measure for calculating
 * the inter-rater agreement for two or more raters applying set-valued
 * annotations. The measure is neither chance-corrected nor weighted.<br>
 * <br>
 * References:
 * <ul>
