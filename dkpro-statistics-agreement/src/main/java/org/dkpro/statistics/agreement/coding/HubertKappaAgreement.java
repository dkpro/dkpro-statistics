 ...
 * Bulletin 88(2):322-328, 1980.</li>
 * <li>Davies, M. &amp; Fleiss, J.L.: Measuring agreement for multinomial data. Biometrics
 * 38(4):1047–1051, 1982.</li>
 * <li>Hubert, L.: Kappa revisited. Psychological Bulletin 84(2):289-297, 1977.</li>
 * </ul>
 * 
    ...
    extends CodingAgreementMeasure
{
    ...
    public double calculateExpectedAgreement()
    {
        ...
        result = result.divide(
                new BigDecimal(study.getRaterCount())
