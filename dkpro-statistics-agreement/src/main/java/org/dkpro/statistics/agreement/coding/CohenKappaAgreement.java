    ...
    implements IChanceCorrectedAgreement, ICategorySpecificAgreement
{
    ...
    /**
     * Calculates the expected inter-rater agreement that assumes a different probability
     * distribution for all raters.
     * 
    ...
    /**
     * Computes the maximum possible value of the kappa coefficient for the provided study. In case
     * of balanced off-marginals (i.e., an equal disagreement for each pair of categories), the
     * maximum kappa is 1. In other cases, it decreases with a higher discrepancy of the
