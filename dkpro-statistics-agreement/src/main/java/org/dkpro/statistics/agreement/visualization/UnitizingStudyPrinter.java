...
public class UnitizingStudyPrinter
{
    ...
    /**
     * Iterate all raters, identify the corresponding annotation units, and visualize them using
     * {@link #printUnitsForRater(PrintStream, IUnitizingAnnotationStudy, int, Object, String)}.
     * Optionally, the given prefix is printed left of the continuum scale and the output is
     * correctly indented.
     */
    public void printUnitsForCategory(final PrintStream out, final IUnitizingAnnotationStudy study,
