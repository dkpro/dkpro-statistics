...
/**
 * Generalization of Bennett et al.'s (1954) S-measure for calculating a
 * chance-corrected inter-rater agreement for multiple raters, which is known
 * as Randolph's (2005) kappa. The measure assumes a uniform probability
 * distribution for all raters and categories. It yields thus identical
 * results as Bennett's S.<br><br>
 * References:<ul>
