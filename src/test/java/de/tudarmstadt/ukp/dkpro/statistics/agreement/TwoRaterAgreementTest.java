    ...
    extends TestCase
{
    ...
    // public void testTwoRaterAgreementSingleItem()
    // {
    // final AnnotationStudy study = new AnnotationStudy(2);
    // study.addItem("c", "c");
    //
    // final double expectedObservedAgreement = 1.0;
    // final double actualObservedAgreement = new TwoRaterObservedAgreement(study)
    // .calculateAgreement();
    // Assert.assertEquals(expectedObservedAgreement, actualObservedAgreement, 1.0);
    //
    ...
    {
        final IAnnotationStudy study = AgreementTestExamples.createArtsteinPoesio2008_1();

        // Two raters, observed agreement.
        final TwoRaterObservedAgreement raw = new TwoRaterObservedAgreement(study);
        assertEquals(0.7, raw.calculateAgreement(), 0.001);

        final TwoRaterObservedCategoryAgreement cat = new TwoRaterObservedCategoryAgreement(study);
        ...
        final TwoRaterSAgreement s = new TwoRaterSAgreement(study);
        ...
        final TwoRaterPiAgreement pi = new TwoRaterPiAgreement(study);
        ...
        final TwoRaterKappaAgreement kappa = new TwoRaterKappaAgreement(study);
    ...
    {
        final IAnnotationStudy study = AgreementTestExamples.createArtsteinPoesio2008_2();
    ...
    {
        final AnnotationStudy study = AgreementTestExamples.createMeyer2009_1();

        final TwoRaterObservedAgreement raw = new TwoRaterObservedAgreement(study);
        final double agreement = raw.calculateAgreement();
        final double se = raw.standardError(agreement);
        final double[] ci = raw.confidenceInterval(agreement, se,
